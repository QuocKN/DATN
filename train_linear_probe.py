...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-drone", type=int, default=500, help="Max number of drone images used")
    parser.add_argument("--max-non-drone", type=int, default=500, help="Max number of non-drone images used")
