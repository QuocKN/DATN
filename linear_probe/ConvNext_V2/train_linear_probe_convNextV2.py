...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train linear classifiers on ConvNeXt V2 embeddings for drone spectrogram detection")
    parser.add_argument("--drone-root", type=str, help="Path to drone spectrogram images", default="/home/quocnk/Documents/NKQuoc/Data/Spectrum/balanced_binary_dataset/drone/train")
    parser.add_argument("--non-drone-root", type=str, help="Path to non-drone spectrogram images", default="/home/quocnk/Documents/NKQuoc/Data/Spectrum/balanced_binary_dataset/non_drone/train")
    parser.add_argument("--artifact-out", type=str, help="Output .joblib for trained classifier", default="linear_probe/ConvNext_V2/trained_classifier.joblib")
...
def main() -> None:
    ...
    feature_model = load_feature_model(device=device, backbone_name=args.backbone)
