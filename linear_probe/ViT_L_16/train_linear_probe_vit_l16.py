...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train a default SVM classifier on ViT-L-16 embeddings for drone spectrogram detection"
    )
    parser.add_argument(
        "--drone-root",
        type=str,
    ...
    parser.add_argument(
        ...
        default="linear_probe/ViT_L_16/trained_classifier.joblib",
    )
