...
IMAGE_SIZE = 224
FEATURE_EXTRACTOR = "vit_l_16_imagenet_cls_token"
...
def load_feature_model(device: torch.device) -> torch.nn.Module:
    ...
    # Linear probe: extract fixed CLS embedding from frozen backbone.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train linear classifiers on ViT-L-16 embeddings for drone spectrogram detection")
    ...
    parser.add_argument("--artifact-out", type=str, help="Output .joblib for trained classifier", default="linear_probe/ViT_L_16/trained_classifier.joblib")
