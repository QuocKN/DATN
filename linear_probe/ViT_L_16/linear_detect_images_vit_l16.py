...
ARTIFACT_IN = "linear_probe/ViT_L_16/trained_classifier.joblib"
SOURCE_DIR = "/home/quocnk/Documents/NKQuoc/Data/RF/Tu_thu/drone2/spectrograms"
OUTPUT_JSON = "linear_probe/ViT_L_16/report/Tu_thu/2toan/results.json"
OUTPUT_CHART = "linear_probe/ViT_L_16/report/Tu_thu/2toan/results_chart.png"
IMAGE_SIZE = 224
DEVICE = "cuda:0"
BATCH_SIZE = 32
NUM_WORKERS = 4
...
def main() -> None:
    ...
    if feature_extractor and feature_extractor != FEATURE_EXTRACTOR:
        raise ValueError(
            "This detector expects a ViT-L-16 artifact, "
