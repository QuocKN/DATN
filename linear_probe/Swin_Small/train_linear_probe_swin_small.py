...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train linear classifiers on Swin V2 Small embeddings for drone spectrogram detection")
    ...
    parser.add_argument("--artifact-out", type=str, help="Output .joblib for trained classifier", default="linear_probe/Swin_Small/trained_classifier.joblib")
