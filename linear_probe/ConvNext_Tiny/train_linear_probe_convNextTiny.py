...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train linear classifiers on ConvNeXt Tiny embeddings for drone spectrogram detection")
    ...
    parser.add_argument("--artifact-out", type=str, help="Output .joblib for trained classifier", default="trained_classifier.joblib")
...
def main() -> None:
    ...
    summary = {
        "feature_extractor": "convnext_tiny_imagenet_penultimate",
        "image_size": args.image_size,
        "device": str(device),
        "n_total": int(len(y)),
