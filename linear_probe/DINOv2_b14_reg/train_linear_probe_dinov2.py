...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train linear classifiers on DINOv2 embeddings for drone spectrogram detection")
    ...
    parser.add_argument("--artifact-out", type=str, help="Output .joblib for trained classifier", default="linear_probe/DINOv2_b14_reg/trained_classifier.joblib")
