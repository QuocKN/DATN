...
ARTIFACT_IN = "linear_probe/DINOv2_b14_reg/trained_classifier.joblib"
SOURCE_DIR = "E:\\DATN_DATA\\RF\\spectrograms\\2toanbin"
OUTPUT_JSON = "linear_probe/DINOv2_b14_reg/report/Tu_thu/2toan/results.json"
OUTPUT_CHART = "linear_probe/DINOv2_b14_reg/report/Tu_thu/2toan/results_chart.png"
IMAGE_SIZE = 224
DEVICE = "cuda:0"
BATCH_SIZE = 64
NUM_WORKERS = 4
...
def main() -> None:
    ...
    if feature_extractor and feature_extractor != FEATURE_EXTRACTOR:
        raise ValueError(
            "This detector expects a DINOv2 artifact, "
