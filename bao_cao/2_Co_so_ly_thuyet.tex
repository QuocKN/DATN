...
Chương này trình bày các cơ sở lý thuyết phục vụ cho bài toán phát hiện drone dựa trên tín hiệu RF. Nội dung chương bắt đầu từ nguyên lý phát hiện drone thông qua liên kết vô tuyến giữa drone và bộ điều khiển, sau đó giới thiệu bản chất tín hiệu RF, đặc điểm truyền thông của drone thương mại, kỹ thuật truyền dẫn thường gặp và cách thu nhận tín hiệu bằng SDR dưới dạng mẫu I/Q. Tiếp theo, chương trình bày cách chuyển đổi tín hiệu sang biểu diễn thời gian--tần số bằng spectrogram, các đặc trưng liên quan đến chất lượng tín hiệu và những nền tảng học sâu được sử dụng trong các chương sau. Các nội dung này tạo cơ sở để xây dựng pipeline xử lý, huấn luyện và đánh giá mô hình phát hiện drone trong phạm vi đồ án.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{Hinh_ve/chap2/OFDM.png}
