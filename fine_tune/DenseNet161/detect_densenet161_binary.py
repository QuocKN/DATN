...
CHECKPOINT_IN = r"d:\balanced_densenet161_binary.pt"
SOURCE_DIR = r"e:\Data_22_6\Drone_tu_thu_full\drone\drone_10m_spectrograms"
OUTPUT_JSON = "fine_tune/DenseNet161/report/test/results.json"
OUTPUT_CHART = "fine_tune/DenseNet161/report/test/results_chart.png"
IMAGE_SIZE = 224
DEVICE = "cuda:0"
BATCH_SIZE = 128
NUM_WORKERS = 4
...
def visualize_detection_results(
    ...
    fig.suptitle(
        f"{drone_name}\n\n"
        f"Fine-tuned DenseNet161 Detection Results | Model: {model_name or 'unknown'} | "
...
def main() -> None:
    ...
    summary = {
        "method": "densenet161_finetuned_classifier",
        "model_name": checkpoint.get("model_name", "densenet161_binary_finetuned"),
        "backbone_name": checkpoint.get("backbone_name", "densenet161"),
