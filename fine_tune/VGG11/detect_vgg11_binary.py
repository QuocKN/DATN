...
CHECKPOINT_IN = r"D:\balanced_vgg11_binary_data_v4.pt"
SOURCE_DIR = r"e:\Data_22_6\Drone_tu_thu_full\drone\drone_10m_spectrograms"
OUTPUT_JSON = "fine_tune/VGG11/report/test/results.json"
OUTPUT_CHART = "fine_tune/VGG11/report/test/results_chart.png"
IMAGE_SIZE = 224
DEVICE = "cuda:0"
BATCH_SIZE = 128
NUM_WORKERS = 4
...
def visualize_detection_results(
    ...
    fig.suptitle(
        f"{drone_name}\n\n"
        f"Fine-tuned VGG11-BN Detection Results | Model: {model_name or 'unknown'} | "
...
def main() -> None:
    ...
    summary = {
        "method": "vgg11_bn_finetuned_classifier",
        "model_name": checkpoint.get("model_name", "vgg11_bn_binary_finetuned"),
