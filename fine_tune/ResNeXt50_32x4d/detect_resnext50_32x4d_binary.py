...
CHECKPOINT_IN = r"d:\balanced_resnext50_32x4d_binary.pt"
SOURCE_DIR = r"e:\Data_22_6\Drone_tu_thu_full\drone\drone_10m_spectrograms"
OUTPUT_JSON = "fine_tune/ResNeXt50_32x4d/report/test/results.json"
OUTPUT_CHART = "fine_tune/ResNeXt50_32x4d/report/test/results_chart.png"
IMAGE_SIZE = 224
DEVICE = "cuda:0"
BATCH_SIZE = 128
NUM_WORKERS = 4
...
def visualize_detection_results(
    ...
    fig.suptitle(
        f"{drone_name}\n\n"
        f"Fine-tuned ResNeXt50-32x4d Detection Results | Model: {model_name or 'unknown'} | "
...
def main() -> None:
    ...
    summary = {
        "method": "resnext50_32x4d_finetuned_classifier",
        "model_name": checkpoint.get("model_name", "resnext50_32x4d_binary_finetuned"),
        "backbone_name": checkpoint.get("backbone_name", "resnext50_32x4d"),
