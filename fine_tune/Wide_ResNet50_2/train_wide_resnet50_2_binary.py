...
def build_model(freeze_backbone: bool) -> nn.Module:
    try:
        ...
        raise RuntimeError(
            "Could not load pretrained Wide ResNet50-2 ImageNet weights; refusing to train from random initialization."
        ) from exc
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fine-tune Wide ResNet50-2 for binary drone/non-drone spectrogram detection")
    ...
    parser.add_argument("--out-dir", type=str, default="fine_tune/Wide_ResNet50_2/wide_resnet50_2_binary_runs")
...
def main() -> None:
    ...
    best_path = out_dir / "balanced_wide_resnet50_2_binary.pt"
    history = []
