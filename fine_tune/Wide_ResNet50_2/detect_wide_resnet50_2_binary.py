...
CHECKPOINT_IN = r"d:\balanced_wide_resnet50_2_binary_data_v4.pt"
...
OUTPUT_JSON = "fine_tune/Wide_ResNet50_2/report/test/results.json"
OUTPUT_CHART = "fine_tune/Wide_ResNet50_2/report/test/results_chart.png"
IMAGE_SIZE = 224
DEVICE = "cuda:0"
BATCH_SIZE = 128
NUM_WORKERS = 4
...
def normalize_checkpoint(raw_checkpoint: object) -> dict:
    ...
    return {
        "model_name": "wide_resnet50_2_binary_finetuned",
...
def visualize_detection_results(
    ...
    fig.suptitle(
        f"{drone_name}\n\n"
        f"Fine-tuned Wide ResNet50-2 Detection Results | Model: {model_name or 'unknown'} | "
...
def main() -> None:
    ...
    summary = {
        "method": "wide_resnet50_2_finetuned_classifier",
        "model_name": checkpoint.get("model_name", "wide_resnet50_2_binary_finetuned"),
        "backbone_name": checkpoint.get("backbone_name", "wide_resnet50_2"),
