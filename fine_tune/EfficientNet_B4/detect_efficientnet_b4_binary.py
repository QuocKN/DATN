...
CHECKPOINT_IN = r"d:\balanced_efficientnet_b4_binary_data_v4.pt"
SOURCE_DIR = r"e:\Data_22_6\Drone_tu_thu_full\drone\drone_10m_spectrograms"
OUTPUT_JSON = "fine_tune/EfficientNet_B4/report/test/results.json"
OUTPUT_CHART = "fine_tune/EfficientNet_B4/report/test/results_chart.png"
IMAGE_SIZE = 380
DEVICE = "cuda:0"
BATCH_SIZE = 64
NUM_WORKERS = 4
...
def visualize_detection_results(
    ...
    fig.suptitle(
        f"{drone_name}\n\n"
        f"Fine-tuned EfficientNet-B4 Detection Results | Model: {model_name or 'unknown'} | "
...
def main() -> None:
    ...
    summary = {
        "method": "efficientnet_b4_finetuned_classifier",
        "model_name": checkpoint.get("model_name", "efficientnet_b4_binary_finetuned"),
        "backbone_name": checkpoint.get("backbone_name", "efficientnet_b4"),
