...
DEFAULT_CLASS_NAMES = ["non_drone", "drone"]

# Edit these values directly.
CHECKPOINT_IN = r"d:\balanced_googlenet_binary_data_v4.pt"
# SOURCE_DIR = r"e:\Data_22_6\Drone_tu_thu_full\drone\drone_60m_spectrograms"
SOURCE_DIR = r"e:\Data_22_6\Drone_tu_thu_full\non_drone\non_drone_outdoor_t11_wifi_spectrograms"
OUTPUT_JSON = "fine_tune/GoogLeNet/report/test/results.json"
OUTPUT_CHART = "fine_tune/GoogLeNet/report/test/results_chart.png"
IMAGE_SIZE = 224
DEVICE = "cuda:0"
BATCH_SIZE = 128
NUM_WORKERS = 4
...
def normalize_checkpoint(raw_checkpoint: object) -> dict:
    if isinstance(raw_checkpoint, dict) and "state_dict" in raw_checkpoint:
        return raw_checkpoint

    return {
        "model_name": "googlenet_binary_finetuned",
...
def visualize_detection_results(
    ...
    fig.suptitle(
        f"{drone_name}\n\n"
        f"Fine-tuned GoogLeNet Detection Results | Model: {model_name or 'unknown'} | "
...
def main() -> None:
    ...
    checkpoint = normalize_checkpoint(torch.load(checkpoint_path, map_location=device))
    ...
    summary = {
        "method": "googlenet_finetuned_classifier",
        "model_name": checkpoint.get("model_name", "googlenet_binary_finetuned"),
        "backbone_name": checkpoint.get("backbone_name", "googlenet"),
