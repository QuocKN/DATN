...
CHECKPOINT_IN = "fine_tune/ResNet18/resnet18_binary_runs/balanced_resnet18_binary.pt"
SOURCE_DIR = "/home/quocnk/Documents/NKQuoc/Data/RF/Tu_thu/drone2/spectrograms"
OUTPUT_JSON = "fine_tune/ResNet18/report/Tu_thu/2toan_results.json"
OUTPUT_CHART = "fine_tune/ResNet18/report/Tu_thu/2toan_results_chart.png"
IMAGE_SIZE = 224
DEVICE = "cuda:0"
BATCH_SIZE = 128
NUM_WORKERS = 4
...
def visualize_detection_results(
    ...
    fig.suptitle(
        f"Fine-tuned ResNet18 Detection Results | Model: {model_name or 'unknown'} | "
...
def main() -> None:
    ...
    summary = {
        "method": "resnet18_finetuned_classifier",
        "model_name": checkpoint.get("model_name", "resnet18_binary_finetuned"),
