...
CHECKPOINT_IN = r"d:\balanced_vit_l16_binary_data_v4.pt"
SOURCE_DIR = r"e:\Data_22_6\Drone_tu_thu_full\drone\drone_80m_spectrograms"
OUTPUT_JSON = "fine_tune/ViT_L16/report/test/results.json"
OUTPUT_CHART = "fine_tune/ViT_L16/report/test/results_chart.png"
IMAGE_SIZE = 224
DEVICE = "cuda:0"
BATCH_SIZE = 128
NUM_WORKERS = 4
...
def visualize_detection_results(
    ...
    fig.suptitle(
        f"{drone_name}\n\n"
        f"Fine-tuned ViT-L/16 Detection Results | Model: {model_name or 'unknown'} | "
...
def main() -> None:
    ...
    summary = {
        "method": "vit_l16_finetuned_classifier",
        "model_name": checkpoint.get("model_name", "vit_l16_binary_finetuned"),
        "backbone_name": checkpoint.get("backbone_name", "vit_l_16"),
