...
CHECKPOINT_IN = r"/kaggle/input/datasets/kqucnguyn/model-dronedetect-final/Fine_tune/DinoV2/balanced_dinov2_vits14_binary.pt"
# SOURCE_DIR = "/kaggle/input/datasets/kqucnguyn/data-test-spectrograms/drone_evaluate/drone_evaluate"
