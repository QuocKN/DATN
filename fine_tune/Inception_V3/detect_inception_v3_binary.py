...
CHECKPOINT_IN = r"d:\balanced_inception_v3_binary_data_v4.pt"
...
OUTPUT_JSON = "fine_tune/Inception_V3/report/test/results.json"
OUTPUT_CHART = "fine_tune/Inception_V3/report/test/results_chart.png"
IMAGE_SIZE = 299
DEVICE = "cuda:0"
BATCH_SIZE = 128
NUM_WORKERS = 4
...
def normalize_checkpoint(raw_checkpoint: object) -> dict:
    ...
    return {
        "model_name": "inception_v3_binary_finetuned",
...
def visualize_detection_results(
    ...
    fig.suptitle(
        f"{drone_name}\n\n"
        f"Fine-tuned Inception V3 Detection Results | Model: {model_name or 'unknown'} | "
...
def main() -> None:
    ...
    summary = {
        "method": "inception_v3_finetuned_classifier",
        "model_name": checkpoint.get("model_name", "inception_v3_binary_finetuned"),
        "backbone_name": checkpoint.get("backbone_name", "inception_v3"),
